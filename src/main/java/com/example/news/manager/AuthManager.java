...
import com.example.news.mapper.AuthenticationMapper;
...
public class AuthManager {
    ...
    public String getUsernameById(Integer userId) {
        return authenticationMapper.getUsernameById(userId);
    }
    ...
    public List<UserPO> getUserInfoAll() {
        ...
        return authenticationMapper.getUserInfoAll();
    }
    ...
    public List<String> getRoleNameByUserName(String userName) {
        ...
        return authenticationMapper.getRoleNameByUserName(userName);
    }
    ...
    public Integer getUserIdByUserName(String userName) {
        ...
        return authenticationMapper.getUserIdByUserName(userName);
    }
    ...
    public List<String> getPermissionNameByUserName(List<String> roleNames) {
        ...
        return authenticationMapper.getPermissionNameByUserName(roleNames);
    }
    ...
    public UserPO getUserInfoByUserName(String userName) {
        ...
        return authenticationMapper.getUserInfoByUserName(userName);
    }
    ...
    public List<RolePO> getRoleInfoByRoleId(List<Integer> roleIds) {
        ...
        return authenticationMapper.getRoleInfoByRoleIds(roleIds);
    }
    ...
    public List<PermissionPO> getPermissionInfoByPerssionId(List<Integer> perssionId) {
        ...
        return authenticationMapper.getPermissionInfoByPerssionId(perssionId);
    }
    ...
    public List<Integer> getUserToRoleInfoByUserId(Integer userId) {
        ...
        return authenticationMapper.getUserToRoleInfoByUserId(userId);
    }
    ...
    public List<Integer> getRoleToPermissionByRoleId(List<Integer> roleId) {
        ...
        return authenticationMapper.getRoleToPermissionByRoleId(roleId);
    }
}
